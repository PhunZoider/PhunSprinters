...
local profileName = "PhunSprintersSprinter"
PhunSprintersSprinter = ISPanelJoypad:derive(profileName);
local UI = PhunSprintersSprinter
Core.ui = Core.ui or {}
...
function UI:updateTooltip()
    if self.mouseOver and self.tooltip then
        ...
        self.tooltip:setName(Core.sprint and getText("IGUI_PhunSprinters_ZedsAreRestless") or
