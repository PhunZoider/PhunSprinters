...
if (SandboxVars.PhunSprintersUI or {}).AddToLoot then
    ...
    table.insert(ProceduralDistributions.list["ArmyStorageElectronics"].items, "Phun.WristWatch_Left_MilitaryX");
    table.insert(ProceduralDistributions.list["ArmyStorageElectronics"].items, .05);

    -- ArmySurplusMisc
    table.insert(ProceduralDistributions.list["ArmySurplusMisc"].items, "Phun.WristWatch_Left_MilitaryX");
    table.insert(ProceduralDistributions.list["ArmySurplusMisc"].items, 1);

    -- ElectronicStoreAppliances
    table.insert(ProceduralDistributions.list["ElectronicStoreAppliances"].items, "Phun.WristWatch_Left_MilitaryX");
    table.insert(ProceduralDistributions.list["ElectronicStoreAppliances"].items, 2);

    -- ElectronicStoreMisc
    table.insert(ProceduralDistributions.list["ElectronicStoreMisc"].items, "Phun.WristWatch_Left_MilitaryX");
    table.insert(ProceduralDistributions.list["ElectronicStoreMisc"].items, 2);

    -- FireDeptLockers
    table.insert(ProceduralDistributions.list["FireDeptLockers"].items, "Phun.WristWatch_Left_MilitaryX");
    table.insert(ProceduralDistributions.list["FireDeptLockers"].items, 1);

    -- LockerArmyBedroom
    table.insert(ProceduralDistributions.list["LockerArmyBedroom"].items, "Phun.WristWatch_Left_MilitaryX");
    table.insert(ProceduralDistributions.list["LockerArmyBedroom"].items, 1);

    -- MedicalStorageTools
    table.insert(ProceduralDistributions.list["MedicalStorageTools"].items, "Phun.WristWatch_Left_MilitaryX");
    table.insert(ProceduralDistributions.list["MedicalStorageTools"].items, 1);

    -- SecurityLockers
    table.insert(ProceduralDistributions.list["SecurityLockers"].items, "Phun.WristWatch_Left_MilitaryX");
    table.insert(ProceduralDistributions.list["SecurityLockers"].items, 0.5);

    -- PoliceLockers
    table.insert(ProceduralDistributions.list["PoliceLockers"].items, "Phun.WristWatch_Left_MilitaryX");
    table.insert(ProceduralDistributions.list["PoliceLockers"].items, 1);

    -- StoreShelfMedical
    table.insert(ProceduralDistributions.list["StoreShelfMedical"].items, "Phun.WristWatch_Left_MilitaryX");
    table.insert(ProceduralDistributions.list["StoreShelfMedical"].items, 5);

    -- TestingLab
    table.insert(ProceduralDistributions.list["TestingLab"].items, "Phun.WristWatch_Left_MilitaryX");
    table.insert(ProceduralDistributions.list["TestingLab"].items, 1);

    -- ToolStoreTools
    table.insert(ProceduralDistributions.list["ToolStoreTools"].items, "Phun.WristWatch_Left_MilitaryX");
    table.insert(ProceduralDistributions.list["ToolStoreTools"].items, 0.25);

    -- SurvivalGear
    table.insert(ProceduralDistributions.list["SurvivalGear"].items, "Phun.WristWatch_Left_MilitaryX");
    ...
    -- MedicalClinicTools
    table.insert(ProceduralDistributions.list["MedicalClinicTools"].items, "Phun.WristWatch_Left_MilitaryX");
    table.insert(ProceduralDistributions.list["MedicalClinicTools"].items, 3);

    -- ToolStoreAccessories
    table.insert(ProceduralDistributions.list["ToolStoreAccessories"].items, "Phun.WristWatch_Left_MilitaryX");
    table.insert(ProceduralDistributions.list["ToolStoreAccessories"].items, 3);

    -- ArmyHangarTools
    table.insert(ProceduralDistributions.list["ArmyHangarTools"].items, "Phun.WristWatch_Left_MilitaryX");
    table.insert(ProceduralDistributions.list["ArmyHangarTools"].items, 3);

    -- CrateTools
    table.insert(ProceduralDistributions.list["CrateTools"].items, "Phun.WristWatch_Left_MilitaryX");
    table.insert(ProceduralDistributions.list["CrateTools"].items, 3);

    -- GymLockers
    table.insert(ProceduralDistributions.list["GymLockers"].items, "Phun.WristWatch_Left_MilitaryX");
    table.insert(ProceduralDistributions.list["GymLockers"].items, 1);

    -- GunStoreShelf
    table.insert(ProceduralDistributions.list["GunStoreShelf"].items, "Phun.WristWatch_Left_MilitaryX");
    ...
    -- glovebox
    table.insert(VehicleDistributions["GloveBox"].items, "Phun.WristWatch_Left_MilitaryX");
    table.insert(VehicleDistributions["GloveBox"].items, 0.1);

    -- Suburbs
    table.insert(SuburbsDistributions["all"]["inventorymale"].items, "Phun.WristWatch_Left_MilitaryX");
    table.insert(SuburbsDistributions["all"]["inventorymale"].items, 0.05);

    table.insert(SuburbsDistributions["all"]["inventoryfemale"].items, "Phun.WristWatch_Left_MilitaryX");
